...
class SheetManager:
    ...
    def list_files(self):
        ...
        try:
            ...
            for file in files:
                table.add_row(
                    file.get("id"), file.get("name"), file.get("modifiedTime")
                )
    ...
    def read_data(self, sheet_name: str, worksheet_name: str = "Sheet1"):
        ...
        try:
            ...
            console.print(
                f"[red]Worksheet '{worksheet_name}' not found in '{sheet_name}'.[/red]"
            )
            return None
    ...
    def update_cell(
        ...
        try:
            ...
            console.print(
                f"[green]Updated {cell_address} in {sheet_name} to '{value}'[/green]"
            )
        except Exception as e:
    ...
    def append_rows(
        ...
        try:
            ...
            console.print(
                f"[green]Appended {len(rows_data)} rows to {sheet_name}[/green]"
            )
        except Exception as e:
