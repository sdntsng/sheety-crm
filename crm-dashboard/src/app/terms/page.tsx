    ...
    <div className="max-w-3xl mx-auto px-6 py-24">
      ...
      <div className="prose prose-stone max-w-none space-y-6 text-[var(--color-ink-muted)]">
        <section>
          ...
          <p>
            By accessing or using Sheety (&quot;the Service&quot;), you agree to
        ...
        <section>
          ...
          <p>
            Sheety is an open-source application that provides a CRM interface
            for Google Sheets. The Service allows you to view and manage data
            stored in your own Google Sheets through a user-friendly interface.
          </p>
          <div className="bg-[var(--bg-paper)] border border-[var(--border-pencil)] rounded-lg p-4 mt-4">
            ...
            <p className="text-sm mt-1">
              Sheety does not store your CRM data. All data remains in your
              Google Sheet under your full control.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <p>Sheety is released under the MIT License. You are free to:</p>
          <ul className="list-disc pl-6 space-y-2 mt-3">
          ...
          <p className="mt-3">
            The full license is available in the{" "}
            <a
        ...
        <section>
          ...
          <p>
            Sheety integrates with Google services (Sheets, Drive, OAuth). Your
        ...
        <section>
          ...
          <p>
            TO THE MAXIMUM EXTENT PERMITTED BY LAW, SHEETY AND ITS CONTRIBUTORS
        ...
        <section>
          ...
          <p>
            You agree to indemnify and hold harmless Sheety and its contributors
        ...
        <section>
          ...
          <p>
            ...
            revoking Google OAuth access. We reserve the right to terminate or
        ...
        <section>
          ...
          <p>
            ...
            after changes constitutes acceptance of the new Terms. Material
            changes will be communicated through the Service or repository.
          </p>
        </section>
