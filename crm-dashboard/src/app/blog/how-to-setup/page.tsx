...
export default function SetupGuidePage() {
    return (
        ...
        >
            ...
            <blockquote>
                <p>
                    <strong>Tip:</strong> If you're bringing your own sheet, make sure it has the required columns. You can use the "Add Schema Sheet" tool in the setup footer to add a reference sheet with the required column definitions, or download our CSV schemas directly:
                </p>
