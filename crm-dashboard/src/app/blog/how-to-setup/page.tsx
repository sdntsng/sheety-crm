...
export default function SetupGuidePage() {
  return (
    ...
    >
      ...
      <p className="lead">
        Setting up Sheety takes about 30 seconds. Because it just sits on top of
        Google Sheets, there's no database to provision and no complex
        migration.
      </p>

      <h2>Step 1: Sign In</h2>
      <p>
        Sheety uses your Google account for authentication. We don't store
        passwords. Simply click <strong>Sign In</strong> and authorize the app
      ...
      <p>
        Once logged in, you'll be directed to the Setup page. You have two
        primary options:
      </p>

      <h3>Option A: Select from Drive</h3>
      <p>
        If you already have a spreadsheet you want to use, click{" "}
        <strong>Select from Drive</strong>. This will open the Google Picker,
        allowing you to choose any existing sheet.
      </p>

      <div className="my-8 p-8 bg-[var(--bg-surface)] rounded-2xl border border-[var(--border-pencil)] flex justify-center not-prose">
        <motion.div className="w-full max-w-md bg-white rounded-xl shadow-lg border border-[var(--border-color)] overflow-hidden">
          ...
          <div className="p-4 grid grid-cols-3 gap-3">
            {[1, 2, 3].map((i) => (
              ...
              >
                ...
                >
                  ...
                  <path
                    d="M8 15h2v2H8zm0-4h2v2H8zm0 8h2v2H8zm4-8h2v2h-2zm0 4h2v2h-2zm0 4h2v2h-2zm4-8h2v2h-2zm0 4h2v2h-2zm0 4h2v2h-2z"
                    opacity=".3"
                  />
                  <path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z" />
                  <path d="M8 15h2v2H8zm0-4h2v2H8zm0 8h2v2H8zm4-8h2v2h-2zm0 4h2v2h-2zm0 4h2v2h-2zm4-8h2v2h-2zm0 4h2v2h-2zm0 4h2v2h-2z" />
                </svg>
            ...
            {[4, 5, 6].map((i) => (
              <div
                key={i}
                className="aspect-square rounded-lg border border-transparent flex flex-col items-center justify-center gap-2 opacity-30"
              >
      ...
      <p>
        Click <strong>Create New CRM</strong>, give your sheet a name (e.g.,
        "Pipeline 2026"), and we will automatically:
      </p>
      <ul>
        <li>Create a new spreadsheet in your Google Drive.</li>
        <li>
          Create the required tabs: <code>Leads</code>,{" "}
          <code>Opportunities</code>, and <code>Activities</code>.
        </li>
      ...
      <div className="my-8 p-8 bg-[var(--bg-surface)] rounded-2xl border border-[var(--border-pencil)] flex justify-center not-prose">
        ...
        >
          ...
          <div className="absolute bottom-6 right-1/4 pointer-events-none opacity-20">
            <svg
              className="w-8 h-8 text-black rotate-12 drop-shadow-md"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
              <path d="M7 2l12 11.2-5.8.5 3.2 7.5-2 1.2-3.2-7.4-4.6 5.4z" />
            </svg>
          </div>
        </motion.div>
      </div>
      <blockquote>
        <p>
          <strong>Tip:</strong> If you're bringing your own sheet, make sure it
          has the required columns. You can use the "Add Schema Sheet" tool in
          the setup footer to add a reference sheet with the required column
          definitions, or download our CSV schemas directly:
        </p>
      ...
      <p>
        Prefer to set things up yourself? You can use our read-only{" "}
      ...
      <ol>
        <li>
          ...
          <a
            ...
            target="_blank"
            className="font-bold underline text-[var(--accent)]"
          >
            Master Template
          </a>
          .
        ...
        <li>
          Click <strong>File &gt; Make a copy</strong> to save it to your Drive.
        </li>
        <li>
          Return to Sheety and choose <strong>Select from Drive</strong>.
        </li>
      </ol>

      <h2>That's It</h2>
      <p>
        Your CRM is now live. Any change you make in Sheety is instantly
        reflected in your Google Sheet, and vice versa. You own the data,
        forever.
      </p>
    </ArticleLayout>
  );
