...
export default function ManifestoPage() {
    return (
        ...
        >
            ...
            <p>
                In the last decade, we accepted a strange bargain. We gained beautiful interfaces and "cloud convenience," but we lost something fundamental: <strong>Custody</strong>.
            </p>
            <p>
            ...
            <p>
                We built the interface (the buttons, the Kanban boards, the forms), but we deliberately refused to build the database. Instead, we use something you already own: <strong>Google Sheets</strong>.
            </p>
            <p>
                This means:
            </p>
            <ul>
                <li>If Sheety goes offline tomorrow, your business continues running in Sheets.</li>
                <li>If you want to build a custom report, you don't need our API. You just use a pivot table.</li>
                <li>If you want to leave, you don't need to export. You're already out.</li>
            </ul>
            ...
            <p>
                By constraining ourselves to a spreadsheet backend, we are forced to stay simple. We can't build complex, bloated features because the database won't support them. This is a feature, not a bug. It keeps Sheety fast, light, and focused on the one thing that matters: <strong>Moving the deal forward.</strong>
            </p>
