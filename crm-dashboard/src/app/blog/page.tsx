...
const articles = [
  ...
  },
  {
    ...
    subtitle:
      "How to visualize, manage, and accelerate your deal flow sheety-style.",
    date: "Jan 18, 2025",
  ...
  },
  {
    ...
    subtitle:
      "A comprehensive guide to keyboard shortcuts and the Command Palette.",
    date: "Jan 14, 2025",
      ...
      <main className="max-w-4xl mx-auto px-6 pt-12 md:pt-24">
        ...
        <header className="mb-12">
          ...
          <p className="font-sans text-xl text-[var(--color-ink-muted)] max-w-xl font-light">
            Thoughts on data ownership, open source software, and building tools
        ...
        <div className="flex flex-wrap gap-4 mb-16 border-b border-[var(--border-pencil)] pb-4">
          {categories.map((cat) => (
            <button
              ...
              className={`px-4 py-2 font-mono text-xs uppercase tracking-widest rounded-full transition-all border ${
                filter === cat
