...
export default function StatCard({
  ...
  return (
    <div
      className={`paper-card p-4 flex flex-col justify-between h-32 relative ${bgVariants[variant]}`}
    >
      {/* Tape/Pin decoration */}
      ...
      <div>
        ...
        <div
          className={`font-sans font-bold text-3xl tracking-tight ${variant === "success" ? "text-green-700" : "text-[var(--text-primary)]"}`}
        >
          {value}
        </div>
      </div>
