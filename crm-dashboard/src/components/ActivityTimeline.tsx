...
export default function ActivityTimeline({ activities, leadId, oppId, onActivityAdded }: ActivityTimelineProps) {
                ...
                <div className="border-2 border-[var(--accent-blue)] bg-[var(--bg-paper)] p-4 rounded shadow-md">
                    <form onSubmit={handleQuickAdd} className="space-y-3">
                        <div className="flex justify-between items-center mb-2">
                            <h4 className="font-sans font-bold text-sm text-[var(--text-primary)]">Add Activity</h4>
                            <button
                                type="button"
