        ...
        <div className="relative z-10">
          <div className="flex justify-between items-start mb-2">
            ...
            {analysis && analysis.risk_level === "High" && (
              <div
                className="bg-red-500 text-white text-[10px] px-2 py-0.5 rounded-full font-bold animate-pulse"
                title={analysis.risk_reason}
              >
                ⚠️ AT RISK
              </div>
            )}
            {analysis && analysis.risk_level === "Medium" && (
              <div
                className="bg-orange-400 text-white text-[10px] px-2 py-0.5 rounded-full font-bold"
                title={analysis.risk_reason}
              >
                ⚠️ RISKY
              </div>
