      ...
      >
        ...
        <div className="bg-[var(--bg-paper)] border-b-2 border-[var(--border-pencil)] p-6 relative">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="font-sans font-bold text-2xl text-[var(--text-primary)]">
                Convert Lead
              </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="p-4 bg-[var(--bg-paper)] border border-[var(--border-pencil)] border-dashed relative">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <span className="font-sans italic text-[var(--text-secondary)] block">
                    Company
                  </span>
                ...
                {lead.score !== undefined && lead.score !== null && (
                  <div className="col-span-2 pt-2 border-t border-[var(--border-pencil)] border-dotted mt-2 flex items-center justify-between">
                    <span className="font-sans italic text-[var(--text-secondary)]">
                      AI Lead Score
                    </span>
                    <div className="flex items-center gap-2">
                      <span
                        className={`font-mono font-bold text-lg ${getScoreColor(lead.score)}`}
                      >
                        {lead.score}
                      </span>
                      {lead.heat_level && (
                        <span
                          className={`text-[10px] font-mono font-bold uppercase px-1 border border-current ${getHeatColor(lead.heat_level)}`}
                        >
                          {lead.heat_level}
                        </span>
                      )}
