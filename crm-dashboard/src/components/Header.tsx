                ...
                <div className="header-actions ml-auto flex items-center gap-4">
                    ...
                    {isAuthenticated && (
                        <>
                            ...
                            {/* Settings Link */}
                            <Link href="/settings" data-tour="settings" className="p-2 text-[var(--color-ink-muted)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-hover)] rounded-full transition-colors" title="Settings">
